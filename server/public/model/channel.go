...
func (o *Channel) IsValid() *AppError {
	...
	if o.Emoji != "" && (o.Type == ChannelTypeDirect || o.Type == ChannelTypeGroup) {
		return NewAppError("Channel.IsValid", "model.channel.is_valid.emoji_type.app_error", nil, "id="+o.Id, http.StatusBadRequest)
	}
...
// NormalizeChannelEmoji trims surrounding whitespace and wrapping colons so
// channel emojis are stored as a bare name (e.g. "rocket") regardless of
// how the client submitted them.
