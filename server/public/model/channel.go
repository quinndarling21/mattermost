...
type Channel struct {
	...
	// Emoji is an optional emoji name (without surrounding colons) that is
	// displayed next to the channel in the sidebar so channels can be
	// visually categorized. Empty means no emoji is set.
