...
type Channel struct {
	...
	// Emoji is an optional emoji name (without surrounding colons, e.g.
	// "rocket") associated with the channel. It is displayed next to the
	// channel in the left-hand sidebar so users can visually categorize
	// channels. Empty means no emoji is set.
