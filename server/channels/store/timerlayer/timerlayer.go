...
func (s *TimerLayerPostStore) GetPostRemindersForUser(userID string) ([]*model.PostReminderListItem, error) {
	start := time.Now()
...
func (s *TimerLayerPostStore) DeletePostReminder(userID string, postID string) error {
	start := time.Now()
