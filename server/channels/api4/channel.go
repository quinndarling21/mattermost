...
func patchChannel(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	updatingProperties := patch.DisplayName != nil || patch.Name != nil || patch.Header != nil || patch.Purpose != nil || patch.GroupConstrained != nil || patch.DefaultCategoryName != nil || patch.EmojiName != nil
