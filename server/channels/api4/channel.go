...
func updateChannel(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	case model.ChannelTypeGroup, model.ChannelTypeDirect:
		...
		if (channel.Name != "" && channel.Name != oldChannel.Name) || (channel.DisplayName != "" && channel.DisplayName != oldChannel.DisplayName) || (channel.Purpose != oldChannel.Purpose) || channel.Emoji != "" {
