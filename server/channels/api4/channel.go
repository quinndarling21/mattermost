...
func updateChannel(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	case model.ChannelTypeGroup, model.ChannelTypeDirect:
		...
		if (channel.Name != "" && channel.Name != oldChannel.Name) || (channel.DisplayName != "" && channel.DisplayName != oldChannel.DisplayName) || (channel.Purpose != oldChannel.Purpose) || (channel.Emoji != oldChannel.Emoji) {
...
func patchChannel(c *Context, w http.ResponseWriter, r *http.Request) {
	...
	updatingProperties := patch.DisplayName != nil || patch.Name != nil || patch.Header != nil || patch.Purpose != nil || patch.GroupConstrained != nil || patch.DefaultCategoryName != nil || patch.Emoji != nil
	...
	case model.ChannelTypeGroup, model.ChannelTypeDirect:
		...
		if (patch.Name != nil && *patch.Name != oldChannel.Name) || (patch.DisplayName != nil && *patch.DisplayName != oldChannel.DisplayName) || (patch.Purpose != nil && *patch.Purpose != oldChannel.Purpose) || patch.DefaultCategoryName != nil || (patch.Emoji != nil && *patch.Emoji != oldChannel.Emoji) {
